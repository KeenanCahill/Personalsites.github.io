function init() {
  ...
  const backgrounds = [
    `radial-gradient(#7888c2, #0B1023)`,
    `radial-gradient(#D2691E, #161616)`,
    `radial-gradient(#808080, #161616)`,
  ];
  //Tracker
  let current = 0;
  let scrollSlide = 0;
  ...
  function nextSlide(pageNumber) {
    ...
    tl.fromTo(currentLeft, 0.2, { y: "-10%" }, { y: "-100%" })
      .fromTo(currentRight, 0.2, { y: "10%" }, { y: "-100%" }, "-=0.2")
      .to(portofolio, 0.2, { backgroundImage: backgrounds[pageNumber] })
      .fromTo(
        currentPage,
        0.3,
